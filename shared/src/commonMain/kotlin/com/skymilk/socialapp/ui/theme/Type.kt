...
@Composable
fun provideSamsungOneFont(): FontFamily {
    return FontFamily(
...
@Composable
fun provideCompactTypography() = Typography(
    displayLarge = TextStyle(
        fontFamily = provideSamsungOneFont(),
...
@Composable
fun provideCompactMediumTypography() = Typography(
    displayLarge = TextStyle(
        fontFamily = provideSamsungOneFont(),
        fontWeight = FontWeight.Light,
        fontSize = 52.sp,
...
@Composable
fun provideCompactSmallTypography() = Typography(
    displayLarge = TextStyle(
        fontFamily = provideSamsungOneFont(),
        fontWeight = FontWeight.Light,
        fontSize = 47.sp,
...
// MediumTypography
@Composable
fun provideMediumTypography() = Typography(
    displayLarge = TextStyle(
        fontFamily = provideSamsungOneFont(),
        fontWeight = FontWeight.Light,
        fontSize = 62.sp,
...
// ExpandedTypography
@Composable
fun provideExpandedTypography() = Typography(
    displayLarge = TextStyle(
        fontFamily = provideSamsungOneFont(),
        fontWeight = FontWeight.Light,
        fontSize = 68.sp,
